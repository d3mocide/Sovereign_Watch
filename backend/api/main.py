...
from routers import system, tracks, analysis, rf, orbital, infra, news, space_weather, jamming, holding_patterns, satnogs, gdelt, stats, buoys, asam, maritime
...
app.include_router(asam.router)
