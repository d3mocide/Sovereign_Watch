                    ...
                    try:
                        ...
                        for i in range(10):
                            ...
                            if e == 0:
                                ...
                                valid_points.append({"time": t.isoformat()})

                        if valid_points:
                            # ⚡ Bolt: Vectorize LLA conversion over the batch of points
                            # Replaces multiple NumPy array allocations and function calls inside the loop
