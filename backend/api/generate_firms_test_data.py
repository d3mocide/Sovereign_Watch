...
DB_URL = os.getenv(
    "DATABASE_URL",
    "postgres://postgres:password-4-testing@sovereign-timescaledb:5432/sovereign_watch",
)
...
async def generate_mock_data():
    ...
    await conn.close()
    print(
        "Injection complete. Refresh the UI and toggle 'NASA FIRMS' and 'Dark Vessels' to verify."
    )
