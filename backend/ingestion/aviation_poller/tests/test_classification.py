...
class TestADSBClassification:
    ...
    @pytest.mark.parametrize("scenario,input_data,expected_affiliation,expected_platform,expected_size", [
        ...
        ("Government by Substring (Police)", {"ownOp": "CITY OF PORTLAND, PORTLAND POLICE BUREAU", "category": "A1"}, "government", "fixed_wing", "light"),
        ("Government by Substring (Sheriff)", {"ownOp": "Multnomah County Sheriff", "category": "A7"}, "government", "helicopter", "unknown"),
        ("Government by Substring (State Trooper)", {"ownOp": "OHIO STATE TROOPER", "category": "A1"}, "government", "fixed_wing", "light"),
        ("Government by Substring (Justice Dept)", {"ownOp": "DEPT OF JUSTICE", "category": "A1"}, "government", "fixed_wing", "light"),
        ("Government by Callsign Substring", {"flight": "POLICE1", "ownOp": "Unknown"}, "government", "fixed_wing", "unknown"),
